...
export class CalendarComponent implements OnInit, AfterViewInit {
    ...
    private currentUser: string = 'Potato';
    ...
    public timeScale: TimeScaleModel = {enable: true, interval: 45, slotCount: 1};
    ...
    async ngOnInit(): Promise<void> {
        // this is not ethical, but it is what it is...
        // remove the ej2 licence bar
    ...
    eventRender(e: EventRenderedArgs) {
        if (e.data['Open'])
            e.element.style.backgroundColor = '#44ae37';
        else
